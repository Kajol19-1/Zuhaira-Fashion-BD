...
class ProductListResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'name'              => $this->name,
            'slug'              => $this->slug,
            'cost'              => $this->cost . PriceManager::CURRENCY_SYMBLE,
            'price'             => $this->price . PriceManager::CURRENCY_SYMBLE,
            'sku'               => $this->sku,
            'stock'             => $this->stock,
            'status'            => $this->status == Product::STATUS_ACTIVE ? 'Active' : 'Inactive',
            'discount_fixed'    => $this->discount_fixed . PriceManager::CURRENCY_SYMBLE,
