...
class ScriptManager{
    ...
    public function getLocationData()
    {
            ...
            foreach ($divisions['module'] as $key => $division){
                ...
                $district = json_decode($dist_response->body(), true);

            foreach($district['module'] as $district){
                ...
                $area_url =  $dist_url ='https://member.daraz.com.bd/locationtree/api/getSubAddressList?countryCode=BD&addressId='. $district['id'].'&page=addressEdit';
