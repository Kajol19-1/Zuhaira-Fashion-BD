...
const ShopEdit = () =>{
  ...
  const getDistricts = (division_id) =>{
    axios
      .get(`${Constants.BASE_URL}/district/${division_id}`)
      .then((res) =>{
    ...
    axios
      .get(`${Constants.BASE_URL}/area/${district_id}`)
      .then((res) =>{
        setAreas(res.data)
      })
  }
              ...
              <div className="row">
                    ...
                    <div className="card-body">
                      ...
                      <label className={"w-100 mt-4"}>
                        ...
                        <textarea
                          ...
                          value={input.details || ""}
                          onChange={handleInput}
                          placeholder={"Please enter shop details"}
                        />
                        <p className={"login-error-msg"}>
                          <small>
                            {errors.details !== undefined
                ...
                <div className="col-md-6">
                  <div className="card">
                    ...
                    <div className="card-body">
                      <label className={"w-100"}>
                        <p>Address <small>(House/Road/Village ect)</small></p>
                        <input
                          className={
                      ...
                      <label className={"w-100 mt-4"}>
                        ...
                        <p className={"login-error-msg"}>
                          <small>
                            {errors.division_id !== undefined ? errors.division_id[0] : null}
                          </small>
                        </p>
                      </label>  
                      <label className={"w-100 mt-4"}>
                        ...
                        <p className={"login-error-msg"}>
                          <small>
                            {errors.district_id !== undefined ? errors.district_id[0] : null}
                          </small>
                        </p>
                      </label>
                      <label className={"w-100 mt-4"}>
                        ...
                        <p className={"login-error-msg"}>
                          <small>
                            {errors.area_id !== undefined ? errors.area_id[0] : null}
                          </small>
                        </p>
                      </label>
                       <label className={"w-100 mt-4"}>
