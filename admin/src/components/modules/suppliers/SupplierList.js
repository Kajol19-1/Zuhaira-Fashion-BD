                                                   ...
                                                   <thead>
                                                     ...
                                                     <tbody>
                                                        ...
                                                        <tr key={index}>
                                                            ...
                                                            <td>
                                                                    <img onClick={()=>handlePhotoModal(supplier.logo_full)} 
                                                            ...
                                                            <td>
                                                                ...
                                                                <p className={'text-info'}><small>Updated: {supplier.updated_at}</small></p>
                                                            </td>
                                                            <td>
                                                                <button onClick={()=>handleDetailsModal(supplier)} className={'btn btn-sm btn-info my-1'}><i className="fa-solid fa-eye" /></button>
                                                                <Link to={`/supplier/edit/${supplier.id}`}><button className={'btn btn-sm btn-warning my-1 mx-1'}><i className="fa-solid fa-edit" /></button></Link>
                                                                <button onClick={()=>handleSupplierDelete(supplier.id)} className={'btn btn-sm btn-danger my-1'}><i className="fa-solid fa-trash" /></button>
                                                            </td>
                                                        </tr>
                                                        )): <NoDataFound/> }
